<template>
  <DashboardLayout title="Tambah Kegiatan">
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-end gap-4">
      <h1 class="text-neutral-gray-5 mb-5">Profil UMKM</h1>
    </div>
    <div class="row">
      <div class="col-lg-8">
        <div class="card">
        ...
        <input type="text" v-model="form.pesan" class="form-control">
          ...
          <section class="mb-5">
            <h2 class="text-neutral-gray-5">Profil Diri</h2>
              ...
              <p><strong>Kabupaten: </strong>{{data.profil.kabpaten}}</p>
          ...
          <section class="mb-5">
            <h2 class="text-neutral-gray-5 mb-4">Profil Usaha</h2>
              ...
              <p><strong>Alamat Perusahaan: </strong>{{data.usaha.alamat_perusahaaan}}</p>
              <p><strong>Status Perusahaan: </strong>{{data.usaha.status_perusahaaan}}</p>
