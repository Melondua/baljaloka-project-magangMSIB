      ...
      <div class="col-lg-8">
        ...
        <form @submit.prevent="handleSubmit">
          <div class="mb-4">
            ...
            <input type="email" v-model="form.email" class="form-control" id="email" placeholder="Masukkan email Anda">
          ...
          <div class="mb-4">
            ...
            <div class="input-group">
              ...
              <input v-model="form.no_telepon" @focusout="changeHoverState()" @focusin="changeHoverState()"
                type="number" class="form-control " placeholder=" Masukkan no handphone anda" id="no_telepon">
            </div>
            <small class="text-danger" v-if="form.errors.no_telepon">{{
          ...
          <div class="mb-4">
            ...
            <div class="form-check">
              <input v-model="form.investor" class="form-check-input" type="checkbox" id="investor"
                :checked="isInvestor">
